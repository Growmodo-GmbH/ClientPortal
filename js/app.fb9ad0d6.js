  ...
  children: [{
    ...
    children: [{
      ...
      children: [{
        ...
        children: [{
          path: ':taskId',
          component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(133)]).then(__webpack_require__.bind(__webpack_require__, 77133))
        }]
      }, {
        path: 'project',
        children: [{
    ...
    path: 'files',
    component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(308)]).then(__webpack_require__.bind(__webpack_require__, 17308))
  }, {
    path: 'help',
    ...
    children: [{
      path: '',
      component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(661)]).then(__webpack_require__.bind(__webpack_require__, 34661))
    }, {
      path: ':settings_tab',
      component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(661)]).then(__webpack_require__.bind(__webpack_require__, 34661))
    }]
...
const pkjson = {"name":"growmodo_hub","version":"0.9.6-dev","description":"Growmodo, GmbH","productName":"Growmodo Hub","author":{"name":"Growmodo, GmbH","url":"https://www.growmodo.com"},"author.name":"Growmodo, GmbH","author.url":"https://www.growmodo.com","private":true,"theme_color":"#2b67ff","background_color":"#fcfcfd"};
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "getLabelFromValue": () => (/* binding */ getLabelFromValue),
...
/**
 *
 * Clean HTML ritch text
 * @param {String} html HTML string
 * @returns {String} clean HTML string
 */
function cleanMarkup(html, newLine = '\n') {
  const replaced = html
  // Remove Attributes
  ...
  // Add line break
  .replace(/<\/p><p>/gi, `</p>${newLine}<p>`) // Add new line on p.
  .replace(/<\/div><div>/gi, `</div>${newLine}<div>`) // Add new line on div.
  .replace(/<\/p><div>/gi, `</p>${newLine}<div>`) // Add new line on p - div.
  .replace(/<\/div><p>/gi, `</div>${newLine}<p>`) // Add new line on div - p.

  // Tags with only br
  .replace(/<div><br><\/div>/gi, '') // Remove br on div.
  .replace(/<p><br><\/p>/gi, '') // Remove br on p.
  .replace(/<br>/gi, `${newLine}`) // Replace br with new line.
...
/**
 *
 * Get object label based on value
 * @param {Array} opt Options array to search from
 * @param {String} val Value to seach from `opt`
 * @returns {String} Label result from filtered array
 */
function getLabelFromValue(opt, val) {
  if (!Array.isArray(opt)) return val;
  return opt.filter(e => e.value === val)[0]?.label || val;
}
  ...
  methods: {
    formatDynamicAnswersPayload(payload) {
      ...
      for (const id of Object.keys(dynamic_questions)) {
        ...
        dynamic_questions[id].value = this.requestOptionParseOrCleanUpString(val1);
        dynamic_questions[id].alternative_answer = this.requestOptionParseOrCleanUpString(val2);
      }
      return {
        ...payload,
        dynamic_questions
...
/******/ 			return "js/" + (chunkId === 64 ? "chunk-common" : chunkId) + "." + {"48":"ccdb1ec5","64":"95545bc9","78":"e12dc4a6","94":"f2f4d0ae","133":"f190c2b5","141":"cd867589","175":"bf4ff199","214":"df96432b","246":"7fd69d89","259":"b71f38cb","287":"de742efb","308":"e2562f82","365":"ece95d6a","386":"41ead471","403":"c678e630","404":"07977e3a","405":"61f5fb24","422":"89a30506","474":"2b361982","493":"9aa22be1","507":"11e6f354","509":"aec0ec76","539":"6d84f45c","543":"86c92a71","563":"d24d3b4d","617":"74101f89","620":"a32a9cb4","661":"48705cfa","663":"e63c4149","712":"98e0895f","713":"3b0048ea","722":"214caedb","737":"d8680879","775":"a84a93fb","785":"cd2bf9ad","815":"712dcda1","898":"5ddc1461","915":"e8abd1c8","935":"5919d987","966":"a7a028d1"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + chunkId + "." + {"94":"a0a6eca8","175":"28c14466","259":"a0a6eca8","712":"a0a6eca8","785":"a0a6eca8"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			var cssChunks = {"94":1,"175":1,"259":1,"712":1,"785":1};
...
/******/ })()
;
//# sourceMappingURL=app.fb9ad0d6.js.map