...
const routes = [{
  ...
  children: [{
    ...
    children: [{
      path: '',
      component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(262)]).then(__webpack_require__.bind(__webpack_require__, 9847))
    }, {
      path: ':brandId',
      children: [{
        path: '',
        ...
        children: [{
          path: ':taskId',
          component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(144)]).then(__webpack_require__.bind(__webpack_require__, 3144))
        }]
      }, {
        path: 'project',
        children: [{
  ...
  children: [{
    path: '',
    component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(872)]).then(__webpack_require__.bind(__webpack_require__, 6872))
  }]
},
// Error Handlers
{
...
async function getSingleBrand(brandId, orgId = this.activeOrgID) {
  ...
  return await apis.api.get(url).then(res => {
    ...
    if (data.success) {
      ...
      if (brand.id) this.organizationBrands[orgId][brand.id] = brand;
      fn_store/* default.addAPICache */.Z.addAPICache(url, data);
      return data;
    }
  }).catch(e => {
...
/******/ 			return "js/" + (chunkId === 64 ? "chunk-common" : chunkId) + "." + {"48":"fe357986","59":"8ac4b71b","64":"799a6e11","72":"30af6a5d","79":"5eb47fa5","95":"adcb335f","144":"b227344c","175":"69f16547","232":"392d18cd","262":"f9e109c5","378":"f29c4238","386":"f0ae4ec2","397":"13d28c30","404":"edc765be","405":"1f53fc09","409":"c2542a5d","422":"28a0ceb4","480":"7c3ce231","493":"0b2cea49","507":"4142185f","546":"e6f3d455","563":"f7b160fe","594":"e565e9fc","597":"85b3d961","618":"390dc98e","620":"83a173fa","685":"ec5541c8","713":"63f547f5","723":"7bfae9cd","737":"b8810320","775":"fc0b618f","785":"b8b2a0b9","787":"7d332418","872":"628882c6","884":"5d00ff5b","885":"4771863b","966":"d3f206d9"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=app.b729d29b.js.map