  ...
  children: [{
    ...
    children: [{
      ...
      children: [{
        ...
        children: [{
          path: ':taskId',
          component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(922)]).then(__webpack_require__.bind(__webpack_require__, 13922))
        }]
      }, {
        path: 'project',
        children: [{
          path: ':projectId',
          component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(331)]).then(__webpack_require__.bind(__webpack_require__, 16331))
        }]
      }]
    }]
  }, {
    path: 'files',
    component: () => Promise.all(/* import() */[__webpack_require__.e(736), __webpack_require__.e(64), __webpack_require__.e(989)]).then(__webpack_require__.bind(__webpack_require__, 1989))
  }, {
    path: 'help',
...
app(vue_esm_bundler/* createApp */.ri, quasar_user_options).then(app => {
  ...
  return Promise[method]([Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18744)), Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 38812)), Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 29542)), Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77106)), Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 37571))]).then(bootFiles => {
...
const pkjson = {"name":"growmodo_hub","version":"0.10.1-dev","description":"Growmodo, GmbH","productName":"Growmodo Hub","author":{"name":"Growmodo, GmbH","url":"https://www.growmodo.com"},"author.name":"Growmodo, GmbH","author.url":"https://www.growmodo.com","private":true,"theme_color":"#2b67ff","background_color":"#fcfcfd"};
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "getSupportedDisplayImageExt": () => (/* binding */ getSupportedDisplayImageExt),
  ...
  "urlShareToEmbed": () => (/* binding */ urlShareToEmbed)
});
...
function getFileTypeIcon(filename) {
  return `icon-${checkFileExtensions(filename, ['woff', 'woff2', 'ttf', 'otf']) ? 'type-square' : checkFileExtensions(filename, ['webp', 'ico', 'jpg', 'jpeg', 'png', 'svg', 'gif', 'ai', 'eps', 'psd']) ? 'image-03' : 'file-attachment-04'}`;
}
...
/* harmony import */ var quasar_wrappers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(23340);
...
/* harmony import */ var src_assets_scripts_functions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1966);
...
const downloadZip = async (urls, label) => {
  quasar_src_plugins_LoadingBar_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"].start */ .Z.start();
  try {
    if (true) console.log(`Downloading Zip:`, urls);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,quasar_wrappers__WEBPACK_IMPORTED_MODULE_7__/* .boot */ .xr)(({
  app,
  router
}) => {
  /**
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,quasar_wrappers__WEBPACK_IMPORTED_MODULE_4__/* .boot */ .xr)(async ({
  ...
  const {
    loginWithToken
  } = (0,stores_user__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(store);
  if (token) {
    // User has a session
    // Validate session
  ...
  router.beforeEach((to, from, next) => {
    ...
    src_stores_fn_store__WEBPACK_IMPORTED_MODULE_3__/* ["default"].getAuth */ .Z.getAuth() && to.path !== '/auth' && src_assets_config__WEBPACK_IMPORTED_MODULE_2__/* ["default"].noLoginPath.includes */ .Z.noLoginPath.includes(to.path) && !( true && to.query.debugging)) {
      const new_route = {
        path: to.query?.redirect ? decodeURIComponent(to.query?.redirect) : '/'
      };
      next(new_route);
    ...
    // And router path is not /auth
    // Also not a public path
    !src_stores_fn_store__WEBPACK_IMPORTED_MODULE_3__/* ["default"].getAuth */ .Z.getAuth() && to.path !== '/auth' && !checkPathPublicPattern(to.path) && !( true && to.query.debugging)) {
...
;// CONCATENATED MODULE: ./node_modules/@quasar/app-webpack/lib/webpack/loader.js.transform-quasar-imports.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@quasar/app-webpack/lib/webpack/loader.vue.auto-import-quasar.js??ruleSet[0].use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/components/Globals/DynamicDialogConfirmation.vue?vue&type=template&id=6de598fd
...
function DynamicDialogConfirmationvue_type_template_id_6de598fd_render(_ctx, _cache, $props, $setup, $data, $options) {
...
;// CONCATENATED MODULE: ./src/components/Globals/DynamicDialogConfirmation.vue?vue&type=template&id=6de598fd
...
;
const DynamicDialogConfirmation_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(DynamicDialogConfirmationvue_type_script_lang_js, [['render',DynamicDialogConfirmationvue_type_template_id_6de598fd_render]])
...
/* harmony default export */ const FileUploader = ({
  ...
  methods: {
    ...(0,pinia/* mapActions */.nv)(helpers/* default */.Z, ['deleteFile', 'deleteFolder']),
    ...
    async deleteAction(file) {
      ...
      const response = await this[file.folder ? 'deleteFolder' : 'deleteFile'](file.id);
      if (!response?.success) {
        this.$q.notify({
          icon: 'icon-alert-triangle',
          iconColor: 'negative',
...
function removeBrandFile(brandId, file, target_path, orgId = this.activeOrgID) {
  ...
  const uploadedFiles = this.organizationBrands?.[orgId]?.[brandId]?.[target_path];
  if (uploadedFiles) {
...
/******/ 			return "js/" + (chunkId === 64 ? "chunk-common" : chunkId) + "." + {"23":"091ff72a","64":"bdcad5c3","100":"4eaa707c","141":"fd91d61c","142":"6bcfbcd8","207":"a9210f75","214":"d28c0448","246":"29e3ffb1","259":"41a1ba36","287":"45103895","331":"6255481f","363":"08451009","404":"5889cf3e","405":"6ec6b2f9","422":"ab65ab44","423":"50fa7170","435":"647d8dac","474":"f0d398c0","493":"22dda4a4","507":"89a79670","539":"33f4b114","540":"7b7b5858","543":"1af9d9a6","563":"9951f409","582":"185918da","591":"56f49949","614":"18c3e9d9","620":"d0ab4b4c","663":"aec58bcb","713":"5b12ed75","737":"aeba13f8","774":"1705cfb7","775":"7e19b7e8","815":"69b1787c","869":"c405d68d","922":"588a78aa","932":"a906507a","935":"83807e4c","940":"099f1fa3","966":"58e255b1","989":"98bb66a0"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=app.8d3a22b6.js.map